...
// glove_fit_cpp
List glove_fit_cpp(const IntegerVector& i_indices, const IntegerVector& j_indices, const NumericVector& x_values, const int n_rows, const int n_cols, const int n_dims, const double x_max, const double alpha, const double lr, const int epochs, const std::string& weight_type_str, const bool fix_bias, const NumericVector& row_sums, const NumericVector& col_sums, const std::string& init_type, const int seed, const bool verbose, const bool shuffle, const int threads, const bool include_word_embeddings, const bool include_context_embeddings, const double regularization);
RcppExport SEXP _wordembeddings_glove_fit_cpp(SEXP i_indicesSEXP, SEXP j_indicesSEXP, SEXP x_valuesSEXP, SEXP n_rowsSEXP, SEXP n_colsSEXP, SEXP n_dimsSEXP, SEXP x_maxSEXP, SEXP alphaSEXP, SEXP lrSEXP, SEXP epochsSEXP, SEXP weight_type_strSEXP, SEXP fix_biasSEXP, SEXP row_sumsSEXP, SEXP col_sumsSEXP, SEXP init_typeSEXP, SEXP seedSEXP, SEXP verboseSEXP, SEXP shuffleSEXP, SEXP threadsSEXP, SEXP include_word_embeddingsSEXP, SEXP include_context_embeddingsSEXP, SEXP regularizationSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< const double >::type regularization(regularizationSEXP);
    rcpp_result_gen = Rcpp::wrap(glove_fit_cpp(i_indices, j_indices, x_values, n_rows, n_cols, n_dims, x_max, alpha, lr, epochs, weight_type_str, fix_bias, row_sums, col_sums, init_type, seed, verbose, shuffle, threads, include_word_embeddings, include_context_embeddings, regularization));
    return rcpp_result_gen;
END_RCPP
}
// sgns_streaming_cpp
List sgns_streaming_cpp(const List& tokens_list, const IntegerVector& vocab, const NumericVector& type_widths, const int n_dims, const int n_neg, const int window, const double lr, const int epochs, const double context_smoothing, const double subsample, const std::string weights_type, const double weights_alpha, const NumericVector& weights_vec, const int weights_mode, const bool include_target, const double forward_weight, const double backward_weight, const bool clean_distance, const int n_samples, const std::string init_type, const int seed, const bool verbose, const int threads, const double regularization);
RcppExport SEXP _wordembeddings_sgns_streaming_cpp(SEXP tokens_listSEXP, SEXP vocabSEXP, SEXP type_widthsSEXP, SEXP n_dimsSEXP, SEXP n_negSEXP, SEXP windowSEXP, SEXP lrSEXP, SEXP epochsSEXP, SEXP context_smoothingSEXP, SEXP subsampleSEXP, SEXP weights_typeSEXP, SEXP weights_alphaSEXP, SEXP weights_vecSEXP, SEXP weights_modeSEXP, SEXP include_targetSEXP, SEXP forward_weightSEXP, SEXP backward_weightSEXP, SEXP clean_distanceSEXP, SEXP n_samplesSEXP, SEXP init_typeSEXP, SEXP seedSEXP, SEXP verboseSEXP, SEXP threadsSEXP, SEXP regularizationSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< const int >::type threads(threadsSEXP);
    Rcpp::traits::input_parameter< const double >::type regularization(regularizationSEXP);
    rcpp_result_gen = Rcpp::wrap(sgns_streaming_cpp(tokens_list, vocab, type_widths, n_dims, n_neg, window, lr, epochs, context_smoothing, subsample, weights_type, weights_alpha, weights_vec, weights_mode, include_target, forward_weight, backward_weight, clean_distance, n_samples, init_type, seed, verbose, threads, regularization));
    return rcpp_result_gen;
END_RCPP
}
// sgns_from_fcm_cpp
List sgns_from_fcm_cpp(const IntegerVector& i_indices, const IntegerVector& j_indices, const NumericVector& x_values, const int n_words, const int n_contexts, const int n_dims, const int n_neg, const double lr, const int epochs, const std::string init_type, const int seed, const bool verbose, const int threads, const double regularization);
RcppExport SEXP _wordembeddings_sgns_from_fcm_cpp(SEXP i_indicesSEXP, SEXP j_indicesSEXP, SEXP x_valuesSEXP, SEXP n_wordsSEXP, SEXP n_contextsSEXP, SEXP n_dimsSEXP, SEXP n_negSEXP, SEXP lrSEXP, SEXP epochsSEXP, SEXP init_typeSEXP, SEXP seedSEXP, SEXP verboseSEXP, SEXP threadsSEXP, SEXP regularizationSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::traits::input_parameter< const IntegerVector& >::type i_indices(i_indicesSEXP);
    Rcpp::traits::input_parameter< const IntegerVector& >::type j_indices(j_indicesSEXP);
    ...
    Rcpp::traits::input_parameter< const int >::type threads(threadsSEXP);
    Rcpp::traits::input_parameter< const double >::type regularization(regularizationSEXP);
    rcpp_result_gen = Rcpp::wrap(sgns_from_fcm_cpp(i_indices, j_indices, x_values, n_words, n_contexts, n_dims, n_neg, lr, epochs, init_type, seed, verbose, threads, regularization));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_wordembeddings_glove_fit_cpp", (DL_FUNC) &_wordembeddings_glove_fit_cpp, 22},
    {"_wordembeddings_sgns_streaming_cpp", (DL_FUNC) &_wordembeddings_sgns_streaming_cpp, 24},
    {"_wordembeddings_sgns_from_fcm_cpp", (DL_FUNC) &_wordembeddings_sgns_from_fcm_cpp, 14},
    {NULL, NULL, 0}
};
