...
glove_fit_cpp <- function(i_indices, j_indices, x_values, n_rows, n_cols, n_dims, x_max, alpha, lr, epochs, weight_type_str, fix_bias, row_sums, col_sums, init_type, seed, verbose, shuffle, threads, include_word_embeddings, include_context_embeddings) {
